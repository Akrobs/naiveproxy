...
[![Version](https://img.shields.io/badge/version-5.6.11-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.6.11

Версия `5.6.11` добавляет выбор REALITY target из пресетов RU/Global и live-проверку TLS/SNI прямо из Xray-меню. Это помогает выбрать рабочий target без ручного подбора.
...
[Yurich Panel v5.6.11: большой обзор скрипта](ARTICLE_RU.md)
