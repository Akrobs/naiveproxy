...
[![Version](https://img.shields.io/badge/version-5.6.9-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.6.9` исправляет зависание установки после генерации пароля первого пользователя: вопрос о сроке подписки теперь всегда виден в терминале, даже когда значение читается через command substitution.
...
[Yurich Panel v5.6.9: большой обзор скрипта](ARTICLE_RU.md)
