...
[![Version](https://img.shields.io/badge/version-5.5.9-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.9` превращает Unbound в полноценный собственный DNS-резолвер: recursive mode без Google/Cloudflare, DNSSEC, кэш, adblock по желанию и безопасный доступ только для VPN-подсетей.
...
Для VPN-клиентов DNS открывается только по указанным CIDR. Скрипт не разрешает делать open resolver для `0.0.0.0/0`.
