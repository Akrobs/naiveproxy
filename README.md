...
[![Version](https://img.shields.io/badge/version-5.5.4-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.4` автоматизирует выдачу клиента: QR, URI и персональная страница создаются сразу при добавлении пользователя.
