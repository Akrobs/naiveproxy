...
[![Version](https://img.shields.io/badge/version-5.5.5-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.5` делает Telegram-управление проще: у бота появилось русское кнопочное меню, а старые команды остались как резервный ручной режим.
