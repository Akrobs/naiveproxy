...
[![Version](https://img.shields.io/badge/version-5.5.1-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.1` исправляет установку Xray REALITY на новых сборках Xray и сохраняет весь функционал ветки `5.5.x`.
