...
[![Version](https://img.shields.io/badge/version-5.6.4-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.6.4` добавляет публичный бренд **Yurich Proxy** для Naive-compatible transport. Технический `naive+https://` сохранён для совместимости с текущими клиентами, а рядом выдаётся фирменный `yurich://proxy?...` alias для будущего Yurich-клиента.
...
[Yurich Panel v5.6.4: большой обзор скрипта](ARTICLE_RU.md)
