...
[![Version](https://img.shields.io/badge/version-5.5.6-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.6` упрощает выдачу Xray/VLESS: пользователя можно создать прямо из меню 23, а при создании обычного Naive-пользователя скрипт может сразу собрать ему Xray-конфиги и личную страницу подписки.
