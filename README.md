...
[![Version](https://img.shields.io/badge/version-5.5.0-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.0` сфокусирована на управлении пользователями, подписках и Telegram-командах.
