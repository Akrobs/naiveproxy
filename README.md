...
[![Version](https://img.shields.io/badge/version-5.5.12-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
## Что нового в v5.5.12

Версия `5.5.12` добавляет автоматический DNS gateway для клиентов VPN/TUN: если `10.0.0.1` нет на сервере, скрипт может безопасно создать его на `lo` и сразу вставить Aurum DNS в sing-box клиентские конфиги.
