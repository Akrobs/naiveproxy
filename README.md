...
[![Version](https://img.shields.io/badge/version-5.5.7-D4A017?style=for-the-badge)](https://github.com/ivan-yurich/naiveproxy/releases)
...
Версия `5.5.7` расширяет Cloudflare WARP: теперь есть безопасный local proxy mode и отдельный full-tunnel режим для всего исходящего трафика VPS.
